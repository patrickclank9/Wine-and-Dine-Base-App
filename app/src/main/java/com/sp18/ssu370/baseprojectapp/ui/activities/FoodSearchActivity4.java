...
public class FoodSearchActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                foods.addFood(new Food("cheesedsgds4", "food info", "5156", new ArrayList<String>(){{
                    add("crackers");
                    add("peanut butter");
                }}, new ArrayList<String>(){{
                    add("http://www.howmuchisin.com/produce_converters_app/vegetables_large/cheese.png");
                }}));
                foods.addFood(new Food("eggssdfgdsfg4", "food info", "5156", new ArrayList<String>(){{
                    add("crackers");
                    add("peanut butter");
                }}, new ArrayList<String>(){{
                ...
                adapter.setFoodItemClickListener(new FoodSearchAdapter.FoodItemClickListener() {
                    ...
                    public void onFoodItemClicked(Food selectedItem) {
                        Intent navIntent = new Intent(FoodSearchActivity4.this, FoodInfoActivity.class);
        ...
        profilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FoodSearchActivity4.this, ProfileActivity.class));
            }
        });
        ...
        mainactivitybutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FoodSearchActivity4.this, MainActivity.class));
            }
        });
        ...
        mapbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FoodSearchActivity4.this, MapsActivity.class));
            }
        });
